        ...
        <div class="d-flex mt-2">
            ...
            <div class="video-info ms-2 flex-grow-1">
                <div class="d-flex justify-content-between align-items-center">
                    <Link :href="route('hymn.hymns.watch', hymn.slug)">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" data-bs-toggle="modal"
                                    :data-bs-target="'#modal-show-lyrics-' + hymn.id" href="#">ግጥም/Lyrics</a>
                            </li>
                ...
                <div class="d-inline d-flex mt-2">
                    <a :href="route('hymn.channels.show', hymn.channel.slug)" class="thumbnail-link">
                        <h4 class="my-0">{{ hymn.channel.title.length > 40 ? hymn.channel.title.slice(0, 40) + '...' :
            ...
            .replace('a month ago', '1 month ago').replace('a day ago', '1 day ago') }}</h4>
                ...
                <div class="d-flex">
                    ...
                    <h4 class="text-bold mx-1 my-0">•</h4>
                    <h4 class="py-0">More from <template v-for="singer in hymn.singers" :key="singer.id">
                            <Link class="me-2" :href="route('hymn.hymns.singer_hymns', singer.slug)">{{ singer.name }}
                            </Link>
                        </template></h4>
                </div>
            </div>
