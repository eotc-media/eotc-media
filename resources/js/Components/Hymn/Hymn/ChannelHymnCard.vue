...
<template>
            ...
            <div class="video-info ms-2 flex-grow-1">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <h4 class="text-bold mb-0">
                        {{ hymn.title.length > 60 ? hymn.title.slice(0, 60) + '...' : hymn.title }}
                    </h4>
                    </Link>
                    <div class="dropdown">
                ...
                <div class="d-inline">
                    <small class="my-0">{{ hymn.clicks_count }} clicks</small>
                    <small class="text-bold mx-1 my-0">•</small>
                    <small class="py-0">{{ moment(hymn.published_at).fromNow()
            .replace('a month ago', '1 month ago').replace('a day ago', '1 day ago') }}</small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade modal-primary" :id="'modal-edit-lyrics-' + hymn.id" @shown.bs.modal="isModalVisible = true"
        @hidden.bs.modal="isModalVisible = false">
        <div class="modal-dialog">
            <div class="modal-content">
