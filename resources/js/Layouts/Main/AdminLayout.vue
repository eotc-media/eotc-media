...
<template>
    <div class="wrapper">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item" @click="hideSidebar">
                            <Link :href="route('admin.feedbacks.index')" class="nav-link"
                                :class="{ 'active': $page.url.startsWith('/admin/feedbacks') }">
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; {{ new Date().getFullYear() }} <a href="/">EOTC Media</a>.</strong> All
            rights
            reserved.
        </footer>
    </div>
