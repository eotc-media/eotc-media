...
watchEffect(() => {
    if (page.url.includes('/hymns/watch')) {
        ...
        <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
            ...
            <ul class="navbar-nav">
                ...
                <li v-if="$page.props.auth.can.access_admin" class="nav-item">
                    <Link :href="route('hymn.admin.hymns.new')" class="nav-link">አድሚን</Link>
                </li>
                <li class="nav-item">
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <template v-else>
                        ...
                        <div class="info">
                            <a href="#" class="d-block">እንግዳ ተጠቃሚ</a>
                        </div>
                    </template>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item" @click="hideSidebar">
                            <Link :href="route('hymn.hymns.index', [0, 0, 0])" class="nav-link"
                                :class="{ 'active': $page.url.startsWith('/hymn/hymns') }">
                            <i class="nav-icon fa-solid fa-microphone"></i>
                            <p>ሁሉም መዝሙራት</p>
                            </Link>
                        </li>
                        <li class="nav-item" @click="hideSidebar">
                            <Link :href="route('hymn.channels.index')" class="nav-link"
                                :class="{ 'active': $page.url.startsWith('/hymn/channels') }">
                        ...
                        <li class="nav-item" @click="hideSidebar">
                            <Link
                                :href="route('hymn.user.favorites.index', { language: 0, category: 0, sub_category: 0 })"
                                class="nav-link" :class="{ 'active': $page.url.startsWith('/hymn/user/favorites') }">
                            <i class="nav-icon fa-regular fa-star"></i>
                            <p>የተመረጡ መዝሙራት</p>
                            </Link>
                        </li>
                        <li class="nav-item" @click="hideSidebar">
                            <Link :href="route('hymn.user.hymns.index')" class="nav-link"
                                :class="{ 'active': $page.url.startsWith('/hymn/user/hymns') }">
                            <i class="nav-icon fa-solid fa-upload"></i>
                            <p>በእርስዎ የተጫኑ መዝሙሮች</p>
                            </Link>
                        </li>
                    </ul>
                </nav>
