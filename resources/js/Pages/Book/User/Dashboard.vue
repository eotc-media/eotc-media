                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="info-box my-1">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-text">Total books uploaded</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="info-box my-1">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-text">Accepted books</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="info-box my-1">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-number">{{ undecided_books }}</span>
                            <span class="info-box-text">Books waiting approval</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="info-box my-1">
                        ...
                        <div class="info-box-content">
                            <span v-if="last_upload" class="info-box-number">{{
                                    new Date(last_upload.created_at).toLocaleDateString("en-US", {
                                        year: 'numeric', month:
                                            'short', day: 'numeric'
                                    })
                                }}</span>
                            <span v-else class="info-box-number">No upload</span>
                            <span class="info-box-text">Last upload date</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="container-fluid form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input id="author" type="text" class="form-control" v-model="form.author"
                                        name="author" placeholder="Author full name" required autocomplete="author">
                                </div>
                            ...
                            <div class="container-fluid form-group">
                                ...
                                <div><small>Max size 30MB. Please compress your image for better
                                        serving.</small></div>
                                <div><small><a href="https://www.ilovepdf.com/compress_pdf" target="_blank">You can use
                                            this
                                            link to
                            ...
                            <div class="container-fluid form-group">
                                ...
                                <div><small>Max size 10MB. Please compress your image for better
                                        serving.</small></div>
                                <div><small><a href="https://www.iloveimg.com/compress-image" target="_blank">You can
                                            use
                                            this link to
                    ...
                    <div class="container-fluid form-group">
                        ...
                        <div class="input-group mb-3">
                            <textarea id="description" class="form-control" v-model="form.description"
                                name="description" placeholder="Book description (optional)" autocomplete="description"
