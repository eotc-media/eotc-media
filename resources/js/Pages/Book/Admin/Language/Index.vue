...
const submit = () => {
    form.post(route('book.admin.languages.store'), {
        onFinish: () => {
...
const deleteLanguage = (id) => {
    ...
    deleteForm.delete(route('book.admin.languages.destroy', id), {
        onFinish: () => {
            deleteForm.reset()
        },
    })
                ...
                <tbody>
                    <tr v-for="language, index in languages" :key="language.id">
                        ...
                        <td><a class="text-danger" data-bs-toggle="modal" href="#"
                                :data-bs-target="'#modal-delete-' + language.id">delete</a></td>

                        <!-- Delete language modal -->
                        <div class="modal fade modal-danger" :id="'modal-delete-' + language.id">
                                ...
                                <div class="modal-content">
                                    <form @submit.prevent="deleteLanguage(language.id)">
                                        <div class="card mb-0">
                                            ...
                                            <div class="card-body">
                                                <div class="my-4">Are you sure you want to delete this language?
                                                </div>
